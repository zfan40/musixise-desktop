  ...
  export default {
    ...
    methods: {
      ...
      followMusixiser(uid) {
        ...
        this.$store.dispatch('followMusixiser',{userId:uid})
          .then(() => { self.musixiserObj.followStatus = true; console.log('follow success'); });
      },
      unfollowMusixiser(uid) {
        let self = this;

        this.$store.dispatch('unfollowMusixiser',{userId:uid})
          .then(() => { self.musixiserObj.followStatus = false; console.log('unfollow success'); });
      }
    },
    computed: {
    },
    ...
    <div v-if="musixiserObj.userId" class="info" @click="onclickcell" @mouseover="onhovercell" @mouseleave="onleavecell">
        ...
        <transition name="fade">
          <div v-show="maskshow" class="user-mask">
            <img v-if="!musixiserObj.followStatus" class="right-corner-icon" src="./assets/inactive-like.svg" alt="" @click.stop.prevent="followMusixiser(musixiserObj.userId)">
            <img v-if="musixiserObj.followStatus" class="right-corner-icon" src="./assets/active-like.svg" alt="" @click.stop.prevent="unfollowMusixiser(musixiserObj.userId)">
            <!-- <img class="right-corner-icon" src="./assets/active-like" alt=""> -->
